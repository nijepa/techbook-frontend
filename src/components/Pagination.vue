<template>
  <div class="pagination"> 
    <div v-if="lastPage > 1" class="pagination__btns">
      ...
      <button v-if="currentPage > 1" class="form__btn pagination__btn" @click="first">
<!--               <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <button v-if="currentPage > 1" class="form__btn pagination__btn" @click="prev">
<!--               <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <button v-if="currentPage !== lastPage" class="form__btn pagination__btn" @click="next">
        next
<!--               <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <button v-if="currentPage !== lastPage" class="form__btn pagination__btn" @click="last">
        {{ lastPage }}
<!--            <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<!--       <ul>
    ...
    <div class="pagination__perpage">
      <button :class="{'active_pagesize': pageSize === 10}" class="form__btn pagination__btn" @click="setPageSize(10)">
        10
      </button>
      <button v-if="total > 10" :class="{'active_pagesize': pageSize === 20}" class="form__btn pagination__btn" @click="setPageSize(20)">
        20
      </button>
      <button v-if="total > 20" :class="{'active_pagesize': pageSize === 50}" class="form__btn pagination__btn" @click="setPageSize(50)">
        50
      </button>
      per page
    </div>
